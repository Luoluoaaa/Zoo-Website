          ...
          <v-row>
            <v-col cols="12" sm="6" md="3">
              <v-text-field
                ...
                :label="$t('showTicketManagement.show_id')"
                :placeholder="
                  $t('common.pleaseInput') + $t('showTicketManagement.show_id')
                "
            ...
            <v-col class="d-flex" cols="12" sm="6" md="3">
              <v-select
                ...
                :items="admissitems"
                :label="$t('showTicketManagement.Ticket_type')"
      ...
      <v-card color="" :ripple="{ class: null }">
        ...
        <v-card-text>
          <span class="zms-poptip-body">
            {{ $t("showTicketManagement.delete_content") }}
          </span>
          <br />
          <br />
        </v-card-text>
...
} from "../../apis/showTicketManagement";
export default {
