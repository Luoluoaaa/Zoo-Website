        ...
        <v-container>
          <v-row>
            <v-col cols="12" sm="6" md="3">
              <v-text-field
                v-model="submit_ID"
                :label="$t('showTicketManagement.ID')"
                :placeholder="
                  $t('common.pleaseInput') + $t('showTicketManagement.ID')
                "
            ...
            <v-col cols="12" sm="6" md="3">
              <v-text-field
                ...
                :label="$t('showTicketManagement.tour_id')"
                :placeholder="
                  $t('common.pleaseInput') + $t('showTicketManagement.tour_id')
                "
