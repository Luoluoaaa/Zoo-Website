          ...
          <v-row>
            ...
            <v-col cols="12" sm="6" md="3">
              <v-text-field
                ...
                :placeholder="
                  $t('common.pleaseInput') + $t('gettingAroundZoo.age_limit')
                "
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['ageLimit']"
                            :label="$t('gettingAroundZoo.age_limit')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['weightLimit']"
                            :label="$t('gettingAroundZoo.weight_limit')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['rentalDuration']"
                            :label="$t('gettingAroundZoo.rental_duration')"
                          />
                        </v-col>
                      </v-row>
      ...
      <v-card color="" :ripple="{ class: null }">
        ...
        <v-card-text>
          <span class="zms-poptip-body">
            {{ $t("gettingAroundZoo.delete_content") }}
          </span>
          <br />
          <br />
        </v-card-text>
