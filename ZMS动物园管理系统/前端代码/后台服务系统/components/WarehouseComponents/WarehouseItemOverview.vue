                      ...
                      <v-row>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            ...
                            :label="$t('warehouse.item.id')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['type']"
                            :label="$t('warehouse.item.type')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['name']"
                            :label="$t('warehouse.item.name')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['channel']"
                            :label="$t('warehouse.item.channel')"
                          />
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem['price']"
                            :label="$t('warehouse.item.price')"
                          />
                        </v-col>
                      </v-row>
                    </v-container>
      ...
      <v-card color="" :ripple="{ class: null }">
        ...
        <v-card-text>
          <span class="zms-poptip-body">
            {{ $t("warehouse.item.delete_content") }}
          </span>
          <br />
          <br />
        </v-card-text>
