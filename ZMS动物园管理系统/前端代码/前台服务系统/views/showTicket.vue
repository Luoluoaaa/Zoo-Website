            ...
            <el-row :gutter="6">
              <el-col :span="12">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/assets/images/pic-3.e65a90d.jpg"
                    alt=""
                  />
              ...
              <el-col :span="6">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/assets/images/pic-2.b6ee5da.jpg"
                    alt=""
                  />
                  <el-row style="font-size: 20px; text-align: center"
                    >魔幻开启</el-row
              ...
              <el-col :span="6">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/assets/images/pic-1.f16880a.jpg"
                    alt=""
                  />
                  <el-row style="font-size: 20px; text-align: center"
                    >光影传说</el-row
            ...
            <el-row :gutter="6" style="margin-top: px">
              <el-col :span="6">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/assets/images/pic-7.a109adb.jpg"
                    alt=""
                  />
                  <el-row style="font-size: 20px; text-align: center"
                    >魔域仙境</el-row
              ...
              <el-col :span="6">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/assets/images/pic-6.232201d.jpg"
                    alt=""
                  />
                  <el-row style="font-size: 20px; text-align: center"
                    >环球飞车</el-row
              ...
              <el-col :span="12">
                <el-card
                  ...
                  ><img
                    class="msbImg"
                    src="https://cdn.chimelong.com/upload/8f1a304b9350d20c/376ca5340eb529b5.jpg"
                    alt=""
                  />
                  <el-row style="font-size: 20px; text-align: center"
                    >魔幻火轮</el-row
        ...
        <el-col :span="8">
          <el-card class="card2">
            ...
            <el-card class="card3" :body-style="{ padding: '0px' }">
              <el-col :span="6"
                ><span class="blockT">￥{{ p1 }}元/人</span></el-col
              >
            ...
            <el-card class="card3" :body-style="{ padding: '0px' }">
              <el-col :span="6"
                ><span class="blockT">￥{{ p2 }}元/人</span></el-col
              >
              <el-col :span="18" class="rela">
                <div class="spanLine"></div>
                <div style="padding: 20px; font-size: 18px; text-align: center">
            ...
            <el-card class="card3" :body-style="{ padding: '0px' }">
              <el-col :span="6"
                ><span class="blockT">￥{{ p3 }}元/人</span></el-col
              >
              <el-col :span="18" class="rela">
                <div class="spanLine"></div>
                <div style="padding: 20px; font-size: 18px; text-align: center">
            ...
            <el-card class="card3" :body-style="{ padding: '0px' }">
              <el-col :span="6"
                ><span class="blockT">￥{{ p4 }}元/人</span></el-col
              >
              <el-col :span="18" class="rela">
                <div class="spanLine"></div>
                <div style="padding: 20px; font-size: 18px; text-align: center">
            ...
            >
              ...
              <span
                style="
                  ...
                  margin: -10px 20px;
                "
                >票价:{{ howMuch(showForm.value) }}元</span
              >
            </el-form>
          ...
          <el-card class="card2">
            ...
            >
              ...
              <p style="font-weight: bold">
                第一场：{{ showStart[0] }}-{{ showEnd[0] }}<br />第二场：{{
                  showStart[1]
                }}-{{ showEnd[1] }}
              </p>
            </div>
        ...
        <el-col :span="8">
          <el-card class="card2">
            ...
            <div style="font-size: 18px; text-align: center; padding: 10px">
              (<i class="el-icon-zoom-in"></i>点击图片 查看大图)
            </div>
          </el-card>
        </el-col>
      </li>
...
export default {
  ...
  methods: {
    ...
    //获取票价
    howMuch(value) {
      if (value == "全价票") return this.p1;
      else if (value == "优惠票") return this.p2;
      else if (value == "学生票") return this.p3;
      else if (value == "VIP座票") return this.p4;
      else return 0;
    },
    open() {
      ...
      this.$msgbox({
        ...
        message: h("div", null, [
          ...
          h(
            "img",
            { style: "introImg" },
            "https://cdn.chimelong.com/assets/images/pic-pc.72843be.jpg"
          ),
          ...
          h(
            ...
            "适用条件：1、身高达到1.5米及以上的未成年人；2、持有本人有效学生证件；3、2021年应届中高考毕业生也适用该票种，购票中高考生需本人持年度准考证或毕业证验证入园。"
          ),
        ]),
