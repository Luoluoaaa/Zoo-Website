              ...
              <div class="Cards">
                <el-col :span="8" justify="space-around">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <el-button class="link" type="text" @click="get('全价票','环园小火车')"
                      >查看详情></el-button
                    >
                    <div 
                      style="
                ...
                <el-col :span="8" justify="space-around">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <el-button class="link" type="text" @click="get('全价票','空中缆车')"
                      >查看详情></el-button
                    >
                    <div
                      style="
                ...
                <el-col :span="8" justify="space-around">
                  <el-card :body-style="{ padding: '0px' }">
                    ...
                    <el-button class="link" type="text" @click="get('全价票','观光马车');"
                      >查看详情></el-button
                    >
                    <div
                      style="
                                        ...
                                        <el-dialog style="width: 100%;margin:auto;" title="游园交通预订" :visible.sync="dialogFormVisible" :modal-append-to-body="false">
                                          <el-form  :model="vehicleForm" :rules="rules" ref="vehicleForm" label-width="100px" :show-message="true">
                                              ...
                                              <el-form-item  label="购票类型" prop="type" required>
                                                <el-radio-group v-model="vehicleForm.type" text-color="#fff" fill="#a6ce39">
                                                  <el-radio-button label="全价票"></el-radio-button>
                                                  <el-radio-button label="优惠票"></el-radio-button>
                                                </el-radio-group>
                                              </el-form-item>
                                              <span style= "font-weight: bold;font-size: 24px;float:right;margin:-10px 20px" >票价:{{vehicleForm.price=howMuch(vehicleForm.type,vehicleForm.value)}}元</span>
                                            </el-form>
  ...
  data() {
    ...
    return {
      ...
      valid:true,
        ...
        rules: {
          date: [
             {required: true, message: '请选择入园日期', trigger: 'blur' }
          ],
          value: [
            { required: true, message: '请选择游园交通工具',trigger: 'blur'}
          ],
          type: [
            { required: true, message: '请选择票种',trigger: 'blur'}
          ],
        },
        pickerOptions: {
          disabledDate(time) {
  ...
  methods: {
    ...
    post(){
      ...
      .then((response)=>{
        ...
        this.$alert('预定成功！您的单号是：'+this.vehicleForm.ID+'。请凭此单号，持身份原证及其他证件到园区正门售票处付费取票！');        
      })
    ...
    check() {
      ...
      this.$msgbox({
        title: "项目说明",
        message: h("p", null, [
          h("span",{ style: "font-weight: bold;color:#ff5353;font-size: 16px" }, ["费用：￥",this.vehicleData[0].price,"元/人"]),
          h("p",null,["费用包含：同济大学附属动物园",this.vehicleData[0].vehicleCategory,"一人次。"]),
          h("p",null,"有效期限：入园日当天。"),
          h("p",null,["年龄限制：",this.vehicleData[0].ageLimit,"岁以上。"]),
          h("p",null,["体重限制：",this.vehicleData[0].weightLimit,"kg以下。"]),
          h("p",null,["预计乘坐时长：大约",this.vehicleData[0].rentalDuration,"小时。"]),
          h("p",null,["费用包含人身意外险：",this.vehicleData[0].deposit,"万元。"]),
        ]),
