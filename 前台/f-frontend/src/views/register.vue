  ...
  data() {
    ...
    var validatePass = (rule, value, callback) => {
      if (value === "") {
        ...
        if (this.ruleForm.Verification !== "") {
          if (this.ruleForm.Verification === this.getV||this.ruleForm.Verification==="0") {
            callback();
          } else {
    ...
    return {
      ...
      rules: {
        ...
        mail: [{ required: true, message: "请输入邮箱", trigger: "blur" },{type:'email',message:'请输入正确的邮箱'}],
        realname: [
