...
section.c-section
  ...
  ul.c-services
    li.c-services__item
      h3 寄存物品 
      p
        | 你若要寄存物品，你只需要将需寄存的物品交给服务站工作人员，工作人员将给你寄存卡，并请你妥善保管寄存卡，并注意贵重物品不得寄存。
    li.c-services__item
      h3 伞的借用 
      p
        | 您若要借用伞，只需交付20元（每把）人民币押金，工作人员会为您提供借伞卡和您所需的伞。请您在当日内，将借伞卡和您借用的阳、雨伞交还到借伞处，工作人员将退还您所交押金。
    li.c-services__item
      h3 儿童车、手推车借用 
      p
        | 您若需要借用儿童推车，只需交费200元/部，残疾人手推车只需交费500元/部人民币押金，工作人员会为您提供手推车。请您在园内使用，当日将手推车退还到借车处，工作人员将退还您所交押金。
    li.c-services__item
      h3 各种药物
      p
        | 免费为游客提供创口消毒液、创可贴、解暑药、速效救心丸等常备药物。
    li.c-services__item
      h3 免费为游客供应开水和提供微波炉和废物袋
      p
        | 您只需向服务站工作人员说明使用原因，便可使用。请您按使用程序进行操作，废物袋只要你需要可直接向工作人员索要。
    
    li.c-services__item
      h3 留言簿
      p
        | 欢迎游览ZMS动物园的游客对我园提出宝贵的意见和建议，我们将会认真接受和采纳你的意见和建议。我们将以更高的标准，创造更优美的环境，为游客朋友提供优质的服务。
</template>
<script>
export default {
...
:root {
  // COLORS
  --color-brand-primary:rgb(90,130,120);
  --color-brand-primary-h: 255;
  --color-brand-primary-s: 0%;
...
.c-section {
  ...
  span {
    ...
    &:after {
      content: "同济大学附属动物园以为民、便民、利民为服务宗旨，为每位到访的游客提供各类便民服务";
      display: block;
